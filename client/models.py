...
class Combo(models.Model):
    ...
    email = models.ForeignKey(Email, related_name='combos', on_delete=models.CASCADE)
    password = models.ForeignKey(Password, related_name="combos", on_delete=models.CASCADE)
    created = models.DateTimeField(auto_now_add=True)
    updated = models.DateTimeField(auto_now = True)
